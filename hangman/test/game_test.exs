defmodule GameTest do
  ...
  describe "tally/1" do
    ...
    test "single good guess" do
      tally = Game.new_game("wibble") |> Game.make_move("w") |> Game.tally()
    ...
    test "double good guess" do
      tally = Game.new_game("wibble") |> Game.make_move("b") |> Game.tally()
      assert tally.game_state == :good_guess
      assert tally.turns_left == 7
    ...
    test "bad guess" do
      tally = Game.new_game("wibble") |> Game.make_move("a") |> Game.tally()
